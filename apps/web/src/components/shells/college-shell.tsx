...
export function CollegeShell({ children, issuerCode, email, navItems }: CollegeShellProps) {
  const subtitle = issuerCode ? `${issuerCode} — ${email ?? ""}` : email ?? "College Admin";
    ...
    <PortalShell
      ...
      header={
        <PortalHeader
          ...
          icon={COLLEGE_ICON}
          roleBadge="College Admin"
          roleBadgeColor="text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950"
          navItems={navItems}
        />
      }
    >
